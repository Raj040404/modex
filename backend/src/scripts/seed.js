...
async function main() {
    console.log("Seeding database with 50 shows (JS logic)...");
    ...
    for (let i = 0; i < 50; i++) {
        ...
        // SQLite might struggle with massive createMany or locking
        // Using batch transactions or Promise.all
        console.log(`Creating seats for show: ${title}`);
